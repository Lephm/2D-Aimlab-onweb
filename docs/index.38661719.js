...
var _deadlineMode = require("./src/scenes/deadline-mode");
var _deadlineModeDefault = parcelHelpers.interopDefault(_deadlineMode);
var _loseScene = require("./src/scenes/lose-scene");
var _loseSceneDefault = parcelHelpers.interopDefault(_loseScene);
var _menu = require("./src/scenes/menu");
...
scene("loseScene", _loseSceneDefault.default);
scene("menu", _menuDefault.default);
scene("deadlineModeScene", _deadlineModeDefault.default);
go("deadlineModeScene");

},{"kaboom":"hKg7i","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./src/scenes/deadline-mode":"kh4SH","./src/scenes/lose-scene":"7ymkP","./src/scenes/menu":"1cmh9"}],"hKg7i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function u(...e) {
    ...
    if (e.length === 1) {
        ...
        if (We(e[0])) return u(e[0].x, e[0].y);
    ...
    return {
        ...
        lerp (r, t) {
            return u(Ne(this.x, r.x, t), Ne(this.y, r.y, t));
        },
        toFixed (r) {
...
function ir(e, r, t) {
    ...
    , "hue2rgb"), U = t < 0.5 ? t * (1 + r) : t + r - t * r, S = 2 * t - U, v = a(S, U, e + 1 / 3), D = a(S, U, e), V = a(S, U, e - 1 / 3);
...
function le(e) {
    return {
        ...
        mult (r) {
            let t = [];
            for(let a = 0; a < 4; a++)for(let U = 0; U < 4; U++)t[a * 4 + U] = this.m[0 + U] * r.m[a * 4 + 0] + this.m[4 + U] * r.m[a * 4 + 1] + this.m[8 + U] * r.m[a * 4 + 2] + this.m[12 + U] * r.m[a * 4 + 3];
            return le(t);
        },
        multVec4 (r) {
            return {
        ...
        invert () {
            let r = [], t = this.m[10] * this.m[15] - this.m[14] * this.m[11], a = this.m[9] * this.m[15] - this.m[13] * this.m[11], U = this.m[9] * this.m[14] - this.m[13] * this.m[10], S = this.m[8] * this.m[15] - this.m[12] * this.m[11], v = this.m[8] * this.m[14] - this.m[12] * this.m[10], D = this.m[8] * this.m[13] - this.m[12] * this.m[9], V = this.m[6] * this.m[15] - this.m[14] * this.m[7], A = this.m[5] * this.m[15] - this.m[13] * this.m[7], L = this.m[5] * this.m[14] - this.m[13] * this.m[6], N = this.m[4] * this.m[15] - this.m[12] * this.m[7], Y = this.m[4] * this.m[14] - this.m[12] * this.m[6], ie = this.m[5] * this.m[15] - this.m[13] * this.m[7], j = this.m[4] * this.m[13] - this.m[12] * this.m[5], oe = this.m[6] * this.m[11] - this.m[10] * this.m[7], J = this.m[5] * this.m[11] - this.m[9] * this.m[7], ue = this.m[5] * this.m[10] - this.m[9] * this.m[6], y = this.m[4] * this.m[11] - this.m[8] * this.m[7], ye = this.m[4] * this.m[10] - this.m[8] * this.m[6], P = this.m[4] * this.m[9] - this.m[8] * this.m[5];
...
i(St, "wave");
var fn = 1103515245, mn = 12345, or = 2147483648, Pt = Dt(Date.now());
function Dt(e) {
    return {
        seed: e,
        gen (...r) {
...
function Pe(e, r) {
    let t = Mt(e, r);
    return t ? u(e.p1.x + t * (e.p2.x - e.p1.x), e.p1.y + t * (e.p2.y - e.p1.y)) : null;
}
i(Pe, "testLineLine");
function at(e, r) {
    return Be(e, r.p1) || Be(e, r.p2) ? !0 : !!Pe(r, mt(e.p1, u(e.p2.x, e.p1.y))) || !!Pe(r, mt(u(e.p2.x, e.p1.y), e.p2)) || !!Pe(r, mt(e.p2, u(e.p1.x, e.p2.y))) || !!Pe(r, mt(u(e.p1.x, e.p2.y), e.p1));
}
i(at, "testRectLine");
function Be(e, r) {
...
var he = class extends Map {
    ...
    push(r1) {
        let t = this._lastID;
        return this.set(t, r1), this._lastID++, t;
    }
    pushd(r2) {
        let t = this.push(r2);
...
function br(e, r) {
    let t = (()=>{
        var C;
        let o = S(Xt, Wt), f = U(new ImageData(new Uint8ClampedArray([
            255,
            255,
            255,
            255
        ]), 1, 1)), g = (C = r.background) != null ? C : I(0, 0, 0);
        ...
        let E = U(new ImageData(new Uint8ClampedArray([
            128,
            128,
            128,
            255,
...
`) throw new Error(g);
    ...
    i(S, "makeShader");
    function v(o, f, g, R) {
        let x = o.width / f, E = o.height / g, C = 1 / x, O = 1 / E, H = {
        }, re = R.split("").entries();
        for (let [Z, ee] of re)H[ee] = u(Z % x * C, Math.floor(Z / x) * O);
        return {
            tex: o,
            map: H,
            qw: C,
    ...
    i(N, "drawCalls");
    function Y(o) {
        return u(o.x / Ee() * 2 - 1, -o.y / ce() * 2 + 1);
    }
    i(Y, "toNDC");
    function ie(o) {
        t.transform = o.clone();
    ...
    function T(o) {
        ...
        let f = o.width, g = o.height, x = Ge(o.origin || pt).scale(u(f, g).scale(-0.5)), E = o.quad || de(0, 0, 1, 1), C = o.color || I(255, 255, 255), O = (H = o.opacity) != null ? H : 1;
        ye(), j(o.pos), y(o.angle), oe(o.scale), j(x), D([
            {
                pos: Se(-f / 2, g / 2, 0),
                uv: u(o.flipX ? E.x + E.w : E.x, o.flipY ? E.y : E.y + E.h),
                color: C,
                opacity: O
            },
            {
                pos: Se(-f / 2, -g / 2, 0),
                uv: u(o.flipX ? E.x + E.w : E.x, o.flipY ? E.y + E.h : E.y),
                color: C,
                opacity: O
            },
            {
                pos: Se(f / 2, -g / 2, 0),
                uv: u(o.flipX ? E.x : E.x + E.w, o.flipY ? E.y + E.h : E.y),
                color: C,
                opacity: O
            },
            {
                pos: Se(f / 2, g / 2, 0),
                uv: u(o.flipX ? E.x : E.x + E.w, o.flipY ? E.y : E.y + E.h),
                color: C,
                opacity: O
            }
        ], [
            ...
            2,
            3
        ], o.tex, o.shader, o.uniform), P();
    }
    i(T, "drawUVQuad");
    function _(o) {
        var E;
        if (!o.tex) throw new Error('drawTexture() requires property "tex".');
        let f = (E = o.quad) != null ? E : de(0, 0, 1, 1), g = o.tex.width * f.w, R = o.tex.height * f.h, x = u(1);
        if (o.tiled) {
            let C = Math.ceil((o.width || g) / g), O = Math.ceil((o.height || R) / R), re = Ge(o.origin || pt).add(u(1, 1)).scale(0.5).scale(C * g, O * R);
            for(let Z = 0; Z < C; Z++)for(let ee = 0; ee < O; ee++)T(se(ne({
            }, o), {
                pos: (o.pos || u(0)).add(u(g * Z, R * ee)).sub(re),
                scale: x.scale(o.scale || u(1)),
                tex: o.tex,
                quad: f,
                width: g,
                height: R,
        ...
        } else o.width && o.height ? (x.x = o.width / g, x.y = o.height / R) : o.width ? (x.x = o.width / g, x.y = x.x) : o.height && (x.y = o.height / R, x.x = x.y), T(se(ne({
        }, o), {
            scale: x.scale(o.scale || u(1)),
            tex: o.tex,
            quad: f,
    ...
    function z(o, f, g, R, x, E = 1) {
        ...
        for(let re = R; re < x; re += O)H.push(o.add(f * Math.cos(re), g * Math.sin(re)));
    ...
    function X(o) {
        ...
        if (o.width <= 0 || o.height <= 0) return;
        let f = o.width, g = o.height, x = Ge(o.origin || pt).add(1, 1).scale(u(f, g).scale(-0.5)), E = [
            u(0, 0),
            u(f, 0),
            u(f, g),
            u(0, g)
        ...
        if (o.radius) {
            ...
            E = [
                u(C, 0),
                u(f - C, 0),
                ...z(u(f - C, C), C, C, 270, 360),
                u(f, C),
                u(f, g - C),
                ...z(u(f - C, g - C), C, C, 0, 90),
                u(f - C, g),
                u(C, g),
                ...z(u(C, g - C), C, C, 90, 180),
                u(0, g - C),
                u(0, C),
                ...z(u(C, C), C, C, 180, 270)
            ];
    ...
    function W(o) {
        ...
        let R = o.width || 1, x = g.sub(f).unit().normal().scale(R * 0.5), E = [
            f.sub(x),
            f.add(x),
            g.add(x),
            g.sub(x)
    ...
    function k(o) {
        ...
        if (!(f.length < 2)) {
            ...
            } else for(let g = 0; g < f.length - 1; g++)W(se(ne({
            }, o), {
                p1: f[g],
                p2: f[g + 1]
            }));
    ...
    function F(o) {
        ...
        o.radiusX === 0 || o.radiusY === 0 || ae(se(ne({
            ...
            pts: z(u(0), o.radiusX, o.radiusY, (f = o.start) != null ? f : 0, (g = o.end) != null ? g : 360, o.resolution),
            radius: 0
        }));
    }
    i(F, "drawEllipse");
    ...
    function w(o) {
        ...
        let f = o.font, g = (o.text + "").split(""), R = f.qw * f.tex.width, x = f.qh * f.tex.height, E = o.size || x, C = u(E / x).scale(u(o.scale || 1)), O = C.x * R, H = C.y * x, re = 0, Z = H, ee = 0, Ae = [], fe = [], be = null, me = 0;
        for(; me < g.length;){
            let ge = g[me];
            ge === `
` ? (Z += H, re = 0, be = null, Ae.push(fe), fe = []) : (o.width ? re + O > o.width : !1) && (Z += H, re = 0, be != null && (me -= fe.length - be, ge = g[me], fe = fe.slice(0, be)), be = null, Ae.push(fe), fe = []), ge !== `
` && (fe.push(ge), re += O, ge === " " && (be = fe.length)), ee = Math.max(ee, re), me++;
        }
        Ae.push(fe), o.width && (ee = o.width);
        let Ye = [], Me = u(o.pos || 0), Ve = Ge(o.origin || pt).scale(0.5), et = -Ve.x * O - (Ve.x + 0.5) * (ee - O), Ut = -Ve.y * H - (Ve.y + 0.5) * (Z - H), ze = 0;
            ...
            ge.forEach((Ze, Te)=>{
                ...
                if (ze += 1, Je) {
                    let we = {
                        ...
                        ch: Ze,
                        pos: u(Me.x + wt + et + gt, Me.y + xt + Ut),
                        opacity: o.opacity,
                    ...
                    if (o.transform) {
                        ...
                        Ue.pos && (we.pos = we.pos.add(Ue.pos)), Ue.scale && (we.scale = we.scale.scale(u(Ue.scale))), Ue.angle && (we.angle += Ue.angle), Ue.color && (we.color = we.color.mult(Ue.color)), Ue.opacity && (we.opacity *= Ue.opacity);
                    }
                    Ye.push(we);
                }
            });
...
function gr(e = {
    ...
    t.isTouch = "ontouchstart" in window || navigator.maxTouchPoints > 0, t.canvas.addEventListener("mousemove", (w)=>{
        W() ? t.mousePos = u(w.offsetX, w.offsetY).scale(1 / t.scale) : t.mousePos = u(w.offsetX, w.offsetY).scale(1 / t.scale), t.mouseDeltaPos = u(w.movementX, w.movementY).scale(1 / t.scale), t.isMouseMoved = !0;
    });
    let D = [
        "left",
        "middle",
    ...
    t.canvas.addEventListener("mousedown", (w)=>{
        ...
        w.preventDefault();
        let G = w.touches[0];
        t.mousePos = u(G.clientX, G.clientY).scale(1 / t.scale), t.mouseStates.left = "pressed";
    }), t.canvas.addEventListener("touchmove", (w)=>{
        if (!e.touchToMouse) return;
        w.preventDefault();
        let G = w.touches[0];
        t.mousePos = u(G.clientX, G.clientY).scale(1 / t.scale), t.isMouseMoved = !0;
    ...
    function k(w) {
        let G = i((De)=>{
            ...
            let Re = De / 1000, Ee = Re - t.realTime;
            t.realTime = Re, t.skipTime || (t.dt = Ee, t.time += t.dt, t.fpsBuf.push(1 / t.dt), t.fpsTimer += t.dt, t.fpsTimer >= 1 && (t.fpsTimer = 0, t.fps = Math.round(t.fpsBuf.reduce((ce, xe)=>ce + xe
            ) / t.fpsBuf.length), t.fpsBuf = [])), t.skipTime = !1, w();
            for(let ce2 in t.keyStates)t.keyStates[ce2] = Ur(t.keyStates[ce2]);
            for(let ce1 in t.mouseStates)t.mouseStates[ce1] = Ur(t.mouseStates[ce1]);
...
function Ar(e, r, t = {
    ...
    i(Y, "slice");
    function ie(P, T) {
        return U(typeof T == "string" ? fetch(v() + T).then((_)=>_.json()
        ).then((_)=>ie(P, _)
        ) : j(null, P).then((_)=>{
            let z = {
        ...
        return U(new Promise((z, X)=>{
            ...
            j(P, T).then((k)=>{
                fetch(W).then((q)=>q.json()
                    ...
                    for (let F1 of q.meta.frameTags)F1.from === F1.to ? k.anims[F1.name] = F1.from : k.anims[F1.name] = {
                        from: F1.from,
                        to: F1.to,
                        speed: 10,
                        loop: !0
...
function Mr(e, r, t = {
    ...
    function S() {
        ...
        let L = u(0, e.height());
        a.forEach((N, Y)=>{
            let ie = Oe(Y, 0, U, 1, 0.5), j = Oe(Y, 0, U, 0.8, 0.2), oe = (()=>{
                switch(N.type){
                    case "info":
...
var Ir = i((e)=>{
    ...
    i(r, "explode");
    let t = null, a = null;
    e.loadSprite(null, Vr).then((S)=>t = S
    ), e.loadSprite(null, kr).then((S)=>a = S
    );
    function U(S, v = {
    }) {
        var N, Y;
...
var Es = i((e = {
    ...
    function j(n) {
        ...
        let c = s.frames[(h = n.frame) != null ? h : 0];
        if (!c) throw new Error(`frame not found: ${(b = n.frame) != null ? b : 0}`);
        a.drawTexture(se(ne({
        }, n), {
            tex: s.tex,
            quad: c.scale(n.quad || de(0, 0, 1, 1))
        }));
    }
    i(j, "drawSprite");
    function oe(n) {
        var h;
        let s = (h = n.font) != null ? h : V, c = v.fonts[s];
        if (!c) throw new Error(`font not found: ${s}`);
        a.drawText(se(ne({
        }, n), {
            font: c
        }));
    ...
    let J = 1600, ue = "topleft", y = {
        ...
        trigger (n, ...s) {
            this.events[n] && this.events[n].forEach((c)=>c(...s)
            );
        },
        scenes: {
        },
    ...
    i(ye, "layers");
    function P(...n) {
        return n.length > 0 && (y.cam.pos = u(...n)), y.cam.pos.clone();
    }
    i(P, "camPos");
    function T(...n) {
        return n.length > 0 && (y.cam.scale = u(...n)), y.cam.scale.clone();
    }
    i(T, "camScale");
    function _(n) {
    ...
    function $(n) {
        let s = new Map, c = {
            ...
            use (l) {
                ...
                d.cleanups = [];
                for(let m1 in l)if (!k.has(m1)) {
                    if (typeof l[m1] == "function") {
                        let M = l[m1].bind(this);
                        if (q.has(m1)) {
                            d.cleanups.push(this.on(m1, M)), d[m1] = M;
                            continue;
                        } else d[m1] = M;
                    } else d[m1] = l[m1];
                    this[m1] === void 0 && Object.defineProperty(this, m1, {
                        get: ()=>d[m1]
                        ,
                        set: (M)=>d[m1] = M
                        ,
                ...
                ), p()) : l.require && d.cleanups.push(this.on("add", ()=>{
                    p();
                }));
            },
            unuse (l) {
    ...
    i(De, "onDraw");
    function Re(n, s, c) {
        let h = w("collide", n, (d, p, m)=>p.is(s) && c(d, p, m)
        ), b = w("collide", s, (d, p, m)=>p.is(n) && c(p, d, m)
        ), l = G(n, (d)=>{
    ...
    i(Re, "onCollide");
    function Ee(n, s) {
        return typeof n == "function" ? E(n) : G(n, (c)=>{
            if (!c.area) throw new Error("onClick() requires the object to have area() component");
            c.isClicked() && s(c);
        });
    }
    i(Ee, "onClick");
    ...
    function f(n, s) {
        if (Array.isArray(n)) {
            ...
            ;
        } else return typeof n == "function" ? y.on("input", ()=>t.isKeyPressed() && n()
        ) : y.on("input", ()=>t.isKeyPressed(n) && s()
        );
    }
    i(f, "onKeyPress");
    function g(n, s) {
        ...
        ) : y.on("input", ()=>t.isKeyPressedRepeat(n) && s()
        );
    }
    ...
    function R(n, s) {
        if (Array.isArray(n)) {
            ...
            ;
        } else return typeof n == "function" ? y.on("input", ()=>t.isKeyReleased() && n()
        ) : y.on("input", ()=>t.isKeyReleased(n) && s()
        );
    }
    i(R, "onKeyRelease");
    function x(n, s) {
        return typeof n == "function" ? y.on("input", ()=>t.isMouseDown() && n(Y())
        ) : y.on("input", ()=>t.isMouseDown(n) && s(Y())
        );
    }
    i(x, "onMouseDown");
    function E(n, s) {
        return typeof n == "function" ? y.on("input", ()=>t.isMousePressed() && n(Y())
        ) : y.on("input", ()=>t.isMousePressed(n) && s(Y())
        );
    }
    i(E, "onMousePress");
    function C(n, s) {
        return typeof n == "function" ? y.on("input", ()=>t.isMouseReleased() && n(Y())
        ) : y.on("input", ()=>t.isMouseReleased(n) && s(Y())
        );
    }
    i(C, "onMouseRelease");
    function O(n) {
    ...
    i(H, "onCharInput"), t.canvas.addEventListener("touchstart", (n)=>{
        [
            ...n.changedTouches
        ].forEach((s)=>{
            y.trigger("onTouchStart", s.identifier, u(s.clientX, s.clientY).scale(1 / t.scale));
        });
    }), t.canvas.addEventListener("touchmove", (n)=>{
        [
            ...n.changedTouches
        ].forEach((s)=>{
            y.trigger("onTouchMove", s.identifier, u(s.clientX, s.clientY).scale(1 / t.scale));
        });
    }), t.canvas.addEventListener("touchmove", (n)=>{
        [
            ...n.changedTouches
        ].forEach((s)=>{
            y.trigger("onTouchEnd", s.identifier, u(s.clientX, s.clientY).scale(1 / t.scale));
        });
    });
    function re(n) {
    ...
    function be(n) {
        let s = [
            ...
            var d, p, m, M, B, K;
            let b = (p = y.layers[(d = c.layer) != null ? d : y.defLayer]) != null ? p : 0, l = (M = y.layers[(m = h.layer) != null ? m : y.defLayer]) != null ? M : 0;
            return b == l ? ((B = c.z) != null ? B : 0) - ((K = h.z) != null ? K : 0) : b - l;
        });
        return n ? s.filter((c)=>c.is(n)
        ) : s;
    }
    i(be, "get");
    function me(n, s) {
        if (typeof n == "function" && s === void 0) return be().forEach((c)=>c.exists() && n(c)
        );
        if (typeof n == "string" || Array.isArray(n)) return be(n).forEach((c)=>c.exists() && s(c)
        );
    }
    i(me, "every");
    function Ye(n, s) {
        if (typeof n == "function" && s === void 0) return be().reverse().forEach((c)=>c.exists() && n(c)
        );
        if (typeof n == "string" || Array.isArray(n)) return be(n).reverse().forEach((c)=>c.exists() && s(c)
        );
    }
    i(Ye, "revery");
    function Me(n) {
    ...
    function ge(...n) {
        return {
            ...
            moveBy (...s) {
                var d;
                let c = u(...s), h = c.x, b = c.y, l = null;
                if (this.solid && ((d = this.area) == null ? void 0 : d.shape) === "rect") {
                    let p = this.worldArea();
                    me((m)=>{
                        var Nt;
                        if (!this.exists() || m === this || !m.solid || ((Nt = m.area) == null ? void 0 : Nt.shape) !== "rect") return;
                        ...
                        let K = {
                            p1: u(0),
                            p2: u(h, b)
                        }, te = 1, ke = B.p1, Ie = u(B.p1.x, B.p2.y), Le = B.p2, st = u(B.p2.x, B.p1.y), it = 0, Ht = {
                            right: {
                                p1: ke,
                                p2: Ie
                            },
                        ...
                        if (te < 1 && !(te === 0 && it == 1 && !Be(B, u(h, b)))) {
                            let ve = u(-h * (1 - te), -b * (1 - te));
                            h *= te, b *= te, l = ze(m, ve);
                        }
                    });
                }
            ...
            move (...s) {
                return this.moveBy(u(...s).scale(L()));
            },
            moveTo (...s) {
                if (typeof s[0] == "number" && typeof s[1] == "number") return this.moveTo(u(s[0], s[1]), s[2]);
                let c = s[0], h = s[1];
                if (h === void 0) {
                    this.pos = u(c);
                    return;
                }
                let b = c.sub(this.pos);
                if (b.len() <= h * L()) {
                    this.pos = u(c);
                    return;
                }
    ...
    i(nt, "follow");
    function we(n, s) {
        let c = typeof n == "number" ? ot(n) : n.unit();
        return {
            id: "move",
            require: [
                "pos"
    ...
    function Ue(n = 0) {
        ...
        return {
            ...
            update () {
                ...
                dt(this.screenArea(), c) ? s = 0 : (s += L(), s >= n && this.destroy());
            }
        };
    }
    i(Ue, "cleanup");
    function Lr(n = {
        ...
        return {
            ...
            _checkCollisions (b) {
                ...
                for(let l2 in s){
                    let d = s[l2];
                    this.isColliding(d) || delete s[l2];
                }
            },
            worldArea () {
                var M, B, K, te;
                ...
                let d = u((K = this.scale) != null ? K : 1).scale(this.area.scale);
                b *= d.x, l *= d.y;
                let p = Ge(this.origin || ue), m = ((te = this.pos) != null ? te : u(0)).add(this.area.offset).sub(p.add(1, 1).scale(0.5).scale(b, l));
                return {
                    shape: "rect",
                    p1: m,
                    p2: u(m.x + b, m.y + l)
    ...
    function Fr(n, s = {
        ...
        return i(b, "calcTexScale"), {
            ...
            load () {
                if (typeof n == "string" ? c = v.sprites[n] : c = n, !c) throw new Error(`sprite not found: "${n}"`);
                let d = ne({
                }, c.frames[0]);
                s.quad && (d = d.scale(s.quad));
                let p = b(c.tex, d, s.width, s.height);
                this.width = c.tex.width * d.w * p.x, this.height = c.tex.height * d.h * p.y, s.anim && this.play(s.anim);
            },
            draw () {
                j(se(ne({
                }, He(this)), {
    ...
    function $r(n, s) {
        ...
        return n && s && c.pushd({
            ...
            update () {
                c.forEach((h, b)=>{
                    h.time -= L(), h.time <= 0 && (h.action.call(this), c.delete(b));
                });
            }
        };
    }
    ...
    function zr(n = {
        ...
        return {
            ...
            update () {
                ...
                let m = !1;
                if (c) {
                    let B = this.worldArea(), K = c.worldArea(), te = B.p2.y, ke = K.p1.y, Ie = B.p1.x, Le = B.p2.x, st = K.p1.x, it = K.p2.x;
                    !c.exists() || te !== ke || Le < st || Ie > it ? (this.trigger("fall", c), c = null, h = null, m = !0) : h && c.pos && (this.pos = this.pos.add(c.pos.sub(h)), h = c.pos.clone());
                }
                if (!c) {
                    let B = this.move(0, s);
                    if (B) {
                        if (B.isBottom()) {
                            c = B.target;
                            let K = s;
                            s = 0, c.pos && (h = c.pos.clone()), m || (this.trigger("ground", c), b = !0);
            ...
            jump (m) {
                c = null, h = null, s = -m || -this.jumpForce;
            },
            doubleJump (m) {
    ...
    function Qr(n, s = {
        ...
        let c = 0, h = (l = s.fade) != null ? l : 0, b = Math.max(n - h, 0);
        return {
            id: "lifespan",
            update () {
                c += L(), c >= b && (this.opacity = Oe(c, b, n, 1, 0)), c >= n && this.destroy();
            }
        };
    }
    i(Qr, "lifespan");
    ...
    function tn(n, ...s) {
        ...
        let c = y.on("updateStart", ()=>{
            y.events = {
                ...
                angle: 0,
                shake: 0
            }, y.camMousePos = t.mousePos(), y.camMatrix = le(), y.layers = {
            }, y.defLayer = null, y.gravity = J, y.scenes[n](...s), e.debug !== !1 && Ae(), e.burp && fe(), c();
        });
    }
    i(tn, "go");
    function rn(n, s) {
    ...
    function Et(n) {
        let s = n(Xe);
        for(let c in s)Xe[c] = s[c], e.global !== !1 && (window[c] = s[c]);
        return Xe;
    }
    i(Et, "plug");
    function vt() {
    ...
    function sn(n, s) {
        ...
        let c = [], h = u(s.pos || u(0)), b = 0, l = {
            ...
            getPos (...d) {
                let p = u(...d);
                return u(h.x + p.x * s.width, h.y + p.y * s.height);
            },
            spawn (d, ...p) {
                let m = u(...p), M = (()=>{
                    if (s[d]) {
                ...
                if (!M) return;
                let B = u(h.x + m.x * s.width, h.y + m.y * s.height);
    ...
    i(sn, "addLevel");
    function Yt(n) {
        let s = t.canvas.captureStream(n), c = r.ctx.createMediaStreamDestination();
        r.masterNode.connect(c);
        let h = c.stream, [b] = h.getAudioTracks(), l = new MediaRecorder(s), d = [];
        return l.ondataavailable = (p)=>{
            p.data.size > 0 && d.push(p.data);
        }, l.onerror = (p)=>{
            r.masterNode.disconnect(c), s.getTracks().forEach((m)=>m.stop()
            );
        }, l.start(), {
            resume () {
                l.resume();
            ...
            download (p = "kaboom.mp4") {
                ...
                }, l.stop(), r.masterNode.disconnect(c), s.getTracks().forEach((m)=>m.stop()
                );
            }
        };
    }
    ...
    if (Et(Ir), e.plugins && e.plugins.forEach(Et), e.global !== !1) for(let n1 in Xe)window[n1] = Xe[n1];
    let zt = 0;
    function kn() {
        return zt;
    }
    ...
    i(Zt, "updateFrame");
    function on() {
        let n = u(U(), S()), s = y.cam, c = ot(je(0, 360)).scale(s.shake);
        s.shake = Ne(s.shake, 0, 5 * L()), y.camMatrix = le().translate(n.scale(0.5)).scale(s.scale).rotateZ(s.angle).translate(n.scale(-0.5)).translate(s.pos.scale(-1).add(n.scale(0.5)).add(c)), me((h)=>{
    ...
    function an() {
        ...
        if (n === 1) y.loaded = !0, y.trigger("load");
            ...
            let s = U() / 2, c = 24 / a.scale(), h = u(U() / 2, S() / 2).sub(u(s / 2, c / 2));
            a.drawRect({
                pos: u(0),
                width: U(),
                height: S(),
        ...
        if (Q.inspect) {
            let b = function(l, d) {
                ...
                let M = a.fmtText({
                    ...
                    pos: m,
                    color: I(255, 255, 255)
                }), B = M.width + m.x * 2, K = M.height + m.x * 2;
                l.x + B / p >= U() && a.pushTranslate(u(-B, 0)), l.y + K / p >= S() && a.pushTranslate(u(0, -K)), a.drawRect({
                    width: B,
                    height: K,
                    color: I(0, 0, 0),
                    radius: 4,
            ...
            i(b, "drawInspectTxt");
            let s = null, c = v.fonts[A], h = I((n = e.inspectColor) != null ? n : [
                0,
                0,
                255
            ]);
...
`));
        ...
        if (Q.timeScale !== 1) {
            ...
            for(let h = 0; h < 2; h++){
                let b = Q.timeScale < 1;
                a.drawTriangle({
                    p1: u(-c.width - s * (b ? 2 : 3.5), -s),
                    p2: u(-c.width - s * (b ? 2 : 3.5), -s - c.height),
                    p3: u(-c.width - s * (b ? 3.5 : 2), -s - c.height / 2),
                    pos: u(-h * s * 1 + (b ? -s * 0.5 : 0), 0),
                    color: I(255, 255, 255)
                });
            }
            a.drawFmtText(c), a.popTransform();
        }
...
},{}],"kh4SH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gameUtils = require("../utils/game-utils");
...
let deadlineMode = ()=>{
    ...
    loop(1, ()=>{
        ...
        if (timeAllowed <= 0) {
            ...
            } else // Set highscore for the first time
            window.localStorage.setItem("deadlineModeHighscore", currentScore);
            go("loseScene", {
                score: currentScore,
                highscore: highscore,
...
exports.default = deadlineMode;

},{"../utils/game-utils":"lyJMb","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lyJMb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "spawnTarget", ()=>spawnTarget
);
const targetHeight = 100;
const targetWidth = 100;
const targetAliveTime = 2;
const spawnTarget = ()=>{
    const randomPos = rand(// Plus 24 in height because that's where the UI is
    vec2(0 + targetWidth, 0 + targetHeight + 24), vec2(width() - targetWidth, height() - targetHeight));
    let newTarget = add([
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7ymkP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = loseScene;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1cmh9":[function(require,module,exports) {

},{}]},["5UGAA","7BQdY"], "7BQdY", "parcelRequire421b")
